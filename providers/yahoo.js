...
exports.geocode = function (providerOpts, loc, cbk, opts) {
  const options = _.extend({ q: loc, flags: 'J', appid: providerOpts.appid || '[yourappidhere]' }, opts || {});
...
exports.reverseGeocode = function (providerOpts, lat, lng, cbk, opts) {
  const options = _.extend({ q: `${lat}, ${lng}`, gflags: 'R', flags: 'J', appid: providerOpts.appid || '[yourappidhere]' }, opts || {});
